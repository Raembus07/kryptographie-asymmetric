...
import ch.abacus.SecuredMessage;
import ch.abacus.components.PersonDTO;
import ch.abacus.symmetric.decode.DecodeMessage;
import ch.abacus.symmetric.encode.EncodeMessage;
...
public class SymmetricCrypting {
  ...
  public String encodePersonDTO(PersonDTO personDTO, SecretKey sessionKey) throws Exception {
    final var serializedPersonDTO = serialize(personDTO);
    return encode.encode(serializedPersonDTO, sessionKey);
  }

  public PersonDTO decodePersonDTO(String encodedPersonDTO, SecretKey sessionKey) throws Exception {
  ...
  public String serialize(PersonDTO personDTO) throws Exception {
